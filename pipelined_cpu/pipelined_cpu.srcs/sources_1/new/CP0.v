...
module CP0 (
    ...
    //abondon following register
    // output reg [`RegBus] config_o, //configuration about the processor
    // output reg [`RegBus] prid_o, //information abort producer
    ...
    always @(posedge clk ) begin
        if(rst == `RstEnable) begin
            ...
            // count interrupt if compare == count
